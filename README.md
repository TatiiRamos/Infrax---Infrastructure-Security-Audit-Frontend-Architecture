...
* **Solución Aplicada para Auditoría:** Reconfiguración temporal/definitiva en `vite.config.ts` para habilitar el binding en todas las interfaces de red (`0.0.0.0`) y autorizar las peticiones del segmento interno:
